 ...
 *
 * $Id: mcm.cc,v 1.1.1.1.2.2 2010-08-18 07:51:46 mgeilen Exp $
 *
...
namespace SDF
{
     ...
     */
    CDouble maximumCycleMeanCycle(TimedSDFgraph *g, SDFgraphCycle &cycle)
    {
        SDFtime t = 0;
        uint tokens = 0;
        ...
        return ((CDouble)t) / ((CDouble) tokens);
    }
     ...
     */
    static
    CDouble mcmSimpleCycles(TimedSDFgraph *g, bool transpose)
    {
        CDouble mcmGraph = 0.0;
     ...
     */
    CDouble maximumCycleMeanCycles(TimedSDFgraph *g)
    {
        CDouble mcmGraph;
