 ...
 *
 * $Id: sdf3ctg.cc,v 1.1.1.1.2.1 2010-04-25 00:31:45 mgeilen Exp $
 *
...
namespace SDF
{
                      ...
                      uint **distanceMatrix)
    {
        ...
        do
        {
            ...
            length = (uint)mtRand.randNorm((double) settings.lengthAvg, (double)settings.lengthVar,
                                           (double) settings.lengthMin, (double) settings.lengthMax);
        }
